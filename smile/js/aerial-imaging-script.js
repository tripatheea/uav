		function get_all_tiles() {
			...
			for (i = 0; i < list.length; i++) {
				...
				tile['coordinates']['nw'] = [coords[1], coords[0]];
				tile['coordinates']['se'] = [parseFloat(coords[1]) - height, parseFloat(coords[0]) + width];
				
				tile['path'] 		= baseImgURL + tile['coordinates']['nw'][1] + ',' + tile['coordinates']['nw'][0] + '.png';
